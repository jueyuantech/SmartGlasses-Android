...
public class CustomCActivity extends VenusAppBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_c_activity);
    ...
    protected void notifyVenusEnter() {
        VNCommon.setView(VNConstant.View.CUSTOM_C, null);
    }
    ...
    private void initConfig(boolean showHistoryText, boolean showOriginalAndTranslation, boolean useGlassesAudio) {
        ...
        // STEP 1:
        mVenusApp = VNConstant.View.CUSTOM_C;
