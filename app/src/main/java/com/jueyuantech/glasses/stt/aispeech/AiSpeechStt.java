...
public class AiSpeechStt extends SttManager {

    private boolean DEBUG_TRANS = false;
    private String iTransVar = "";

    private static final String HOST = "lasr.duiopen.com/live/ws2";
    private static final String HOST_PLUS = "asr.dui.ai/lasrplus/v1";
    ...
    public AiSpeechStt(String func) {
        ...
        if (isTrans) {
            ...
            targetUrl = PROTOCOL + HOST_PLUS + getTransHandShakeParams(BuildConfig.PROP_AISPEECH_PRODUCT_ID, BuildConfig.PROP_AISPEECH_SECRET_KEY);
            ...
            targetUrl = PROTOCOL + HOST + getHandShakeParams(BuildConfig.PROP_AISPEECH_PRODUCT_ID, BuildConfig.PROP_AISPEECH_SECRET_KEY);
    ...
    private WebSocketListener mWebSocketListener = new WebSocketListener() {
        ...
        public void onFailure(WebSocket webSocket, Throwable t, Response response) {
            ...
            if (null != mOnSttListener) {
                mOnSttListener.onError("onFailure");
            }
        }
        ...
        if (0 == errno) {
            ...
            if (null != lasrResponse) {
                ...
                if (null == result.getInteger("end")) {
                    ...
                    if (DEBUG_TRANS) LogUtil.i("TRANS VAR #### " + transVar);
                    ...
                    if (DEBUG_TRANS) LogUtil.i("TRANS REC =============" + transRec);
