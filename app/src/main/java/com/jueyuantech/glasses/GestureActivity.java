...
public class GestureActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private AiwaysGestureManager.AiwaysGestureListener listener = new AiwaysGestureManager.AiwaysGestureListener() {
        ...
        public boolean onSingleTapUp(MotionEvent motionEvent) {
            ...
            VenusSDK.sendTouchEvent(VenusConstant.TouchEvent.SINGLE_TAP);
            return false;
        }
        ...
        public boolean onDoubleTap(MotionEvent motionEvent) {
            ...
            VenusSDK.sendTouchEvent(VenusConstant.TouchEvent.DOUBLE_TAP);
            return false;
        }
        ...
        public void onLongPress(MotionEvent e) {
            ...
            VenusSDK.sendTouchEvent(VenusConstant.TouchEvent.LONG_PRESS);
        }
