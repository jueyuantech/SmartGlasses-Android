...
import com.jueyuantech.venussdk.bean.HealthInfo;
import com.jueyuantech.venussdk.bean.NavInfo;
...
public class EmulatorActivity extends VenusAppBaseActivity implements AMapNaviListener, AMapNaviViewListener, ParallelRoadListener {
    ...
    protected void notifyVenusEnter() {
        VenusSDK.setView(VenusConstant.View.MAP, null);
    }
    ...
    private void updateNavInfo(NavInfo navInfo) {
        LogUtil.i(gson.toJson(navInfo));
        VenusSDK.updateNav(navInfo, null);
    }

    private void updateHealthInfo() {
        HealthInfo healthInfo = new HealthInfo();
        healthInfo.setBmp((70 + random.nextInt(10)) + " bmp");
        VenusSDK.updateHealth(healthInfo, null);
    }
