...
android {
    ...
    defaultConfig {
        ...
        targetSdk = 33
        versionCode = 1
        versionName = "1.0" + "_" + getGitCommitVersion()
    ...
    buildTypes {
        release {
            ...
            buildConfigField("String", "PROP_UMENG_KEY", "\"${localProp.getProperty("LOCAL_PROP_UMENG_KEY")}\"")
            buildConfigField("String", "PROP_IFLYTEK_APP_ID", "\"${localProp.getProperty("LOCAL_PROP_IFLYTEK_APP_ID")}\"")
            buildConfigField("String", "PROP_IFLYTEK_SECRET_KEY", "\"${localProp.getProperty("LOCAL_PROP_IFLYTEK_SECRET_KEY")}\"")
            ...
            buildConfigField("String", "PROP_AISPEECH_PRODUCT_ID", "\"${localProp.getProperty("LOCAL_PROP_AISPEECH_PRODUCT_ID")}\"")
            buildConfigField("String", "PROP_AISPEECH_SECRET_KEY", "\"${localProp.getProperty("LOCAL_PROP_AISPEECH_SECRET_KEY")}\"")
            buildConfigField("String", "PROP_AZURE_ASR_KEY", "\"${localProp.getProperty("LOCAL_PROP_AZURE_ASR_KEY")}\"")
            buildConfigField("String", "PROP_AZURE_TRANS_KEY", "\"${localProp.getProperty("LOCAL_PROP_AZURE_TRANS_KEY")}\"")
        }
        debug {
...
dependencies {
    ...
    implementation(files("libs/VenusSDK_v1.5.3_2da9696_release.aar"))
}
